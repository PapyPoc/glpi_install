...
if [ "$LANGUE" == "fr" ]; then
    ...
    MSG_INSTALL_SH_GITHUB_CLONE_SUCCESS="Successfully cloned git repository ${GIT}."
    MSG_INSTALL_SH_GITHUB_UPDATE_SUCCESS="Successfully updated git repository ${GIT}."
...
export LANGUE MSG_INSTALL_SH_DETECT_DISTRO MSG_INSTALL_SH_DETECT_DISTRO_NONOK MSG_INSTALL_SH_CHECK_GROUP_1 MSG_INSTALL_SH_CHECK_GROUP_2 \
        MSG_INSTALL_SH_USER_GROUP_1 MSG_INSTALL_SH_USER_GROUP_2 MSG_INSTALL_SH_RESTART_SESSION MSG_INSTALL_SH_RESTART_SCRIPT_SUDO \
        MSG_INSTALL_SH_RESTART_SCRIPT_SU MSG_INSTALL_SH_RESTART_ERROR MSG_INSTALL_SH_DEPENDENCIES_MISSING_01 MSG_INSTALL_SH_DEPENDENCIES_MISSING_02 \
        MSG_INSTALL_SH_DEPENDENCIES_SATISFIED MSG_INSTALL_SH_DEPENDENCIES_FAILED MSG_INSTALL_SH_PACKAGE_MANAGER_NOT_FOUND MSG_INSTALL_SH_DEPENDENCIES_INSTALL_FAILED \
        MSG_INSTALL_SH_DEPENDENCIES_MISSING_AFTER_INSTALL MSG_INSTALL_SH_DEPENDENCIES_INSTALLED MSG_INSTALL_SH_GITHUB_CLONE MSG_INSTALL_SH_GITHUB_UPDATE \
        MSG_INSTALL_SH_GITHUB_CLONE_FAILED MSG_INSTALL_SH_GITHUB_SCRIPT_NOT_FOUND MSG_INSTALL_SH_GITHUB_SCRIPT_EXECUTED MSG_INSTALL_SH_GITHUB_SCRIPT_EXECUTION_FAILED
